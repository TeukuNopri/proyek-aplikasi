        ...
        <script src="<?php echo base_url();?>assets/dashboard/js/vendor/jquery-2.2.4.min.js"></script>
        <!-- bootstrap 4 js -->
        ...
        <script src="<?php echo base_url();?>assets/dashboard/js/jquery.slicknav.min.js"></script>
        ...
        <script src="<?php echo base_url();?>assets/dashboard/js/line-chart.js"></script>
        <!-- all pie chart -->
        <script src="<?php echo base_url();?>assets/dashboard/js/pie-chart.js"></script>
        <!-- others plugins -->
